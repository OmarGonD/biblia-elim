...
struct _app_widgets
{
	GtkWidget *app,				 /* main form */
	    ...
	    *viewtexts_item, *viewpreview_item, *parallel_tab_item, *side_preview_item, *viewcomms_item, *viewdicts_item, *linkedtabs_item, *showversenum_item, *readaloud_item, *versehighlight_item, *annotate_highlight_item, *xrefs_in_verse_list_item, *reading_mode_item, *reading_mode_button, *sidebar_toggle_button, *lectura_sync_item, *lectura_sync_button, *interlineal_item, *button_dict_book, *button_new_tab, /* creates a new passage tab */
